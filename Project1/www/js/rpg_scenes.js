...
Scene_Battle.prototype.update = function() {
    var active = this.isActive();
    this._gaugeWindow.refresh(BattleManager.shouldRestarto);
    $gameTimer.update(active);
    $gameScreen.update();
...
Scene_Battle.prototype.createAllWindows = function() {
    ...
    this.createMessageWindow();
    this.createScrollTextWindow();
    this.createResetGaugeWindow();
};

Scene_Battle.prototype.createResetGaugeWindow = function() {
    this._gaugeWindow = new Window_ResetGauge();
...
Scene_Battle.prototype.createPartyCommandWindow = function() {
    ...
    this._partyCommandWindow.setHandler('restart', this.commandRestart.bind(this));
...
Scene_Battle.prototype.commandRestart = function() {
