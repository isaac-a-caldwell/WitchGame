...
Window_PartyCommand.prototype.makeCommandList = function() {
  console.log("YEP COMMAND LIST")
  this.addCommand(TextManager.fight,  'fight');
  this.addCommand(Yanfly.Param.IBSCmdName, 'inBattleStatus');
...
Window_InBattleStatus.prototype.refresh = function() {
  ...
  this.drawActorSimpleStatus(this._battler, x2, this.lineHeight(), w);
  ...
  if (h >= this.lineHeight() * 6) {
    ...
    for (var i = 2; i < 8; ++i) {
      ...
      if (i % 2 === 0) {
        ...
        x2 = x + Window_Base._faceWidth;// + this.standardPadding();
        y += this.lineHeight();
      }
    }
  }
